...
Revision ID: 60b49c895de6
Revises: 
Create Date: 2024-08-22 20:24:41.990166
...
def upgrade() -> None:
    ...
    sa.Column('is_pwd_set', sa.BOOLEAN(), nullable=True),
    sa.Column('role_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['role_id'], ['IGS_USER_ROLE.role_id'], ),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['IGS_USERS.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('date_of_enquiry', sa.String(), nullable=True),
    ...
    op.create_table('IGS_COURSE_ENQ_COMMENTS',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('job_support_id', sa.Integer(), nullable=True),
    sa.Column('comments', sa.String(), nullable=True),
    sa.Column('commented_at', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['job_support_id'], ['IGS_COURSE_ENQUIRY.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_IGS_COURSE_ENQ_COMMENTS_id'), 'IGS_COURSE_ENQ_COMMENTS', ['id'], unique=False)
    op.create_table('IGS_COURSE_ENQ_PAYMENT',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('job_support_id', sa.Integer(), nullable=True),
    sa.Column('candidate_payment_amount', sa.Integer(), nullable=True),
    sa.Column('candidate_payment_status', sa.String(), nullable=True),
    sa.Column('candidate_payment_date', sa.String(), nullable=True),
    sa.Column('resource_payment_amount', sa.Integer(), nullable=True),
    sa.Column('resource_payment_status', sa.String(), nullable=True),
    sa.Column('resource_payment_date', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['job_support_id'], ['IGS_COURSE_ENQUIRY.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_IGS_COURSE_ENQ_PAYMENT_id'), 'IGS_COURSE_ENQ_PAYMENT', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_IGS_COURSE_ENQ_PAYMENT_id'), table_name='IGS_COURSE_ENQ_PAYMENT')
    op.drop_table('IGS_COURSE_ENQ_PAYMENT')
    op.drop_index(op.f('ix_IGS_COURSE_ENQ_COMMENTS_id'), table_name='IGS_COURSE_ENQ_COMMENTS')
    op.drop_table('IGS_COURSE_ENQ_COMMENTS')
